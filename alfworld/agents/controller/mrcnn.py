...
class MaskRCNNAgent(BaseAgent):
    ...
    def get_instance_seg(self):
        ...
        img_idx = len(glob.glob(self.save_detections_path + '/*.jpg'))
        cv2.imwrite(self.save_detections_path + '/mrcnn_%09d.jpg' % img_idx, img)
        ...
        if self.debug:
            ...
            if self.save_detections_to_disk:
                ...
                for _ in range(10): # save 10 frames
                    ...
                    cv2.imwrite(self.save_detections_path + '/mrcnn_%09d.png' % img_idx, img)
