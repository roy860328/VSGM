...
class Module(seq2seq_im_moca_semantic):
    ...
    def __init__(self, args, vocab):
        ...
        if self.config['semantic_cfg'].GENERAL.DECODER == "MOCAMask":
            decoder = vnn.MOCAMask
        elif self.config['semantic_cfg'].GENERAL.DECODER == "MOCAMaskDepth":
            decoder = vnn.MOCAMaskDepth
        else:
